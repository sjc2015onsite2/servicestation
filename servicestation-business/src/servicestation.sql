...
INSERT INTO `affilate_has_part_orders_persons` VALUES (2,1,1),(2,2,1),(2,3,1),(2,4,1),(2,5,1),(2,6,8),(2,7,1),(2,8,1),(2,9,1),(2,10,1);
...
INSERT INTO `affilate_has_parts_counts` VALUES (2,1,2),(2,2,1),(2,3,15),(2,4,5),(2,5,3);
...
INSERT INTO `affilate_has_services_costs` VALUES (2,1,300000),(2,2,400000),(2,3,150000),(2,4,300000);
...
INSERT INTO `affilate_orders_persons` VALUES (2,39,1),(3,40,4),(3,41,4),(2,43,1),(2,45,1),(2,46,1),(2,50,8),(2,51,1),(2,54,1),(2,55,1),(2,56,1),(2,58,1),(2,59,1),(2,60,1);
...
INSERT INTO `affilate_profile_has_dates_rent` VALUES (2,'2015-02-01',100),(2,'2015-08-05',7000000),(2,'2015-09-05',400000),(2,'2015-09-06',600000),(2,'2015-12-01',100),(4,'2015-08-05',12000000),(4,'2015-09-05',324234),(4,'2015-09-06',400000);
...
INSERT INTO `client_notifications` VALUES (1,'Выполнение заказа переносится на неопределённый срок. Ожидаем запчастей.'),(2,'уведомление'),(3,'notification'),(4,'уккуцаца'),(5,'Отправлен запрос на завод в Штутгард.'),(6,'В этом деле я профи! Всё будет сделано в лучшем виде! Привозите свою детку!'),(7,'Соррян чувак. деталей нет. будут через неделю. но ты привози свою детку. мы её отшлефуем. дааа....'),(8,'Не хватает деталей. Будут скоро. Привозите свой автомобиль. Посмотрим.');
...
CREATE TABLE `comments` (
  ...
  PRIMARY KEY (`comment_id`,`comment`,`date`),
...
INSERT INTO `comments` VALUES (1,'Удобная станция. Советую.','2015-08-02',2,''),(2,'Грамотный специалист. Рекомендую.','2015-08-02',3,''),(3,'}{орошая Станция!','2015-08-19',2,''),(4,'}{орошая Станция!','2015-08-19',2,''),(5,'}{орошая Станция!','2015-08-19',2,''),(6,'Да','2015-08-19',2,''),(7,'Иваныыыч!','2015-08-19',2,''),(8,'Бесит манера общаться','2015-08-24',2,''),(9,'Сволочи, одним словом','2015-08-24',2,''),(10,'То director','2015-08-24',2,''),(11,'dirrrrr','2015-08-24',2,'\0'),(12,'Скрытый омментарий','2015-08-28',2,'\0'),(13,'Друзья советуют','2015-09-05',9,''),(14,'Друзья советуют!','2015-09-05',9,''),(15,'Грубияны!','2015-09-05',9,'\0'),(16,'Механик что надо!','2015-09-05',9,'\0'),(17,'Мы пишем комментарий!(виден всем)','2015-09-05',10,''),(18,'Limp Bizkit','2015-09-05',10,'\0'),(19,'Limp Bizkit','2015-09-05',10,'\0'),(20,'невидивый','2015-09-06',10,'\0'),(21,'невидимый','2015-09-06',10,'\0'),(22,'невидимый 2\r\n','2015-09-06',10,'\0'),(23,'МОй первый комментарий','2015-09-06',11,''),(24,'Комментарий','2015-09-06',11,'\0');
...
INSERT INTO `logginers` VALUES (0,'NULL','NULL',';lsdfmsl;admflsamdclsakmfwasc klmwefmwlkm','MECHANIC'),(1,'Петрович','petrovich','petrovich','MECHANIC'),(2,'Петя','pit','pit','USER'),(3,'Боря','boris','boris','USER'),(4,'Иваныч','ivanych','ivanych','MECHANIC'),(5,'Зина','zina','zina','ACCOUNTANT'),(6,'Виктор Петрович','viktor','viktor','CEO'),(7,'Анатоль','tolik','tolik','USER'),(8,'Ганс','gans','gans','MECHANIC'),(9,'Сергей','Sergey','sergey','USER'),(10,'Сергей','sergen13rs','1995sergenr','USER'),(11,'Сергей','login1','login1','USER');
...
INSERT INTO `marks` VALUES (1,4,'2015-08-02',2),(2,3,'2015-08-17',2),(3,5,'2015-08-24',2),(4,1,'2015-08-28',2),(5,5,'2015-09-05',9),(6,2,'2015-09-05',9),(7,5,'2015-09-05',10),(8,5,'2015-09-06',11);
...
CREATE TABLE `mechanic_profile_has_comments` (
  ...
  PRIMARY KEY (`comment_id`,`mechanic_profile_id`),
  UNIQUE KEY `comment_id_UNIQUE` (`comment_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `mechanic_profile_has_comments` VALUES (1,2),(2,7),(2,8),(1,13),(1,16),(1,18),(1,19),(1,21),(1,22),(1,24);
...
INSERT INTO `order_has_parts_counts` VALUES (43,1,208),(43,2,2),(45,1,78),(45,2,245),(46,1,2),(50,3,2),(54,1,1),(54,2,2),(54,3,5),(59,1,2),(60,3,2);
...
INSERT INTO `orders` VALUES (1,'NEW','2015-08-18',NULL,'Сильная вибрация при скорости больше 80 км//ч',NULL,NULL,NULL),(38,'NEW','2015-08-18',NULL,'Всё время открывается капот. Невозможно ехать.',NULL,NULL,NULL),(39,'ACCEPTED','2015-09-06',NULL,'Муравьи в салоне',NULL,NULL,NULL),(40,'ACCEPTED','2015-08-22','2015-08-25','Бора плохо тянет',NULL,NULL,NULL),(41,'ACCEPTED','2015-08-19',NULL,'Сломалась труба',NULL,NULL,NULL),(42,'NEW','2015-08-19',NULL,'поломка тачки',NULL,NULL,NULL),(43,'READY','2015-08-19','2015-08-25','Коробка предач заедает. колёса отваливаются. крыша сетает. стёклы дребезжат. вонает в салоне. фары отвалились. поцарапанная и не ездит.',2,NULL,NULL),(44,'NEW','2015-08-24',NULL,'Проблема с колесом',NULL,NULL,'(29) 884 21 43'),(45,'ACCEPTED','2015-08-24','2015-08-25','Проблема',4,NULL,'435435435'),(46,'READY','2015-08-24',NULL,'северная проблема',NULL,NULL,NULL),(47,'NEW','2015-08-28',NULL,'Автомобиль не заводится. Щелкает что-то под капотом.',NULL,NULL,NULL),(48,'NEW','2015-08-28',NULL,'Дворники не работают. Стоп сигнал не горит.',NULL,NULL,NULL),(49,'NEW','2015-08-28',NULL,'Отвалился бампер после удара о столб',NULL,NULL,NULL),(50,'ACCEPTED','2015-08-28','2015-09-11','Сигнализация заблокировала автомобиль. Невозможно попасть внурь.',5,NULL,NULL),(51,'ACCEPTED','2015-09-05',NULL,'Стук передней пружины из-за набившейся грязи.',NULL,NULL,'+375(29) 884 21 43'),(52,'NEW','2015-09-05',NULL,'Ещё труба поломалась!',NULL,NULL,NULL),(53,'NEW','2015-09-05',NULL,'И ещё колесо сломалось',NULL,NULL,NULL),(54,'ACCEPTED','2015-09-05','2015-09-12','Ещё в салоне воняет \r\n',6,NULL,NULL),(55,'ACCEPTED','2015-09-05',NULL,'И вообще она мне не нравится!!!!!\r\n',NULL,NULL,NULL),(56,'ACCEPTED','2015-09-05',NULL,'У меня отказали тормоза',NULL,NULL,'+375(29) 884 21 43'),(57,'NEW','2015-09-05',NULL,'Это завяка авторизованного пользователя детка!',NULL,NULL,NULL),(58,'ACCEPTED','2015-09-06',NULL,'неработаю задние тормоза',NULL,NULL,'+375(29) 4243 34 2'),(59,'ACCEPTED','2015-09-06','2015-09-16','неработают передние тормоза',8,NULL,NULL),(60,'ACCEPTED','2015-09-06','2015-09-06','Big problem',NULL,NULL,NULL);
...
INSERT INTO `orders_services_costs` VALUES (43,1,10),(43,2,11),(45,1,10),(45,2,11),(50,1,10),(46,2,11),(54,2,11),(54,1,10),(55,2,11),(55,1,10),(59,2,11),(60,2,400000),(60,1,300000),(60,3,150000);
...
INSERT INTO `orders_services_counts` VALUES (43,1,2),(43,2,1),(45,1,1),(45,2,1),(50,1,1),(46,2,1),(54,2,2),(54,1,1),(55,2,1),(55,1,1),(59,2,1),(60,2,1),(60,1,1),(60,3,1);
...
INSERT INTO `part_order_has_parts_counts` VALUES (1,1,2),(2,1,12),(3,1,200),(3,2,300),(4,1,22),(5,1,1),(6,3,234),(7,3,7),(8,1,2),(8,2,50),(8,3,2),(9,1,1),(10,2,2);
...
INSERT INTO `part_orders` VALUES (1,'2015-08-01','READY',NULL),(2,'2015-08-24','READY',NULL),(3,'2015-08-25','READY',NULL),(4,'2015-08-26','READY',NULL),(5,'2015-08-26','READY',NULL),(6,'2015-09-01','PENDING',NULL),(7,'2015-09-03','READY',NULL),(8,'2015-09-05','READY',NULL),(9,'2015-09-05','READY',NULL),(10,'2015-09-06','READY',NULL);
...
INSERT INTO `parts` VALUES (1,'TRW-76568','Тормозные колодки передние'),(2,'TRW-67904','Тормозные колодки задние'),(3,'Febi-3456','Тяга стабилизатора'),(4,'TRW-2342','Шаровая опора'),(5,'Febi-3q43','Решетка радиатора');
...
INSERT INTO `person_has_dates_salarys` VALUES (1,'2015-01-22',120),(1,'2015-08-06',400000),(1,'2015-09-05',500000),(1,'2015-09-06',200000),(5,'2015-09-05',5000000),(5,'2015-09-06',5000000),(6,'2015-09-05',500000),(6,'2015-09-06',100000),(8,'2015-09-05',150000),(8,'2015-09-06',300000);
...
INSERT INTO `services` VALUES (1,'ТС-3','Замена передних тормозных колодок'),(2,'TC-5','Замена задних тормозных колодок'),(3,'ТС-2','Мойка машины'),(4,'ТС-4','Замена масла');
...
INSERT INTO `site_aggregator_has_orders_stations` VALUES (1,1,3),(1,38,4),(1,39,1),(1,40,2),(1,41,2),(1,42,4),(1,43,1),(1,44,2),(1,45,1),(1,46,1),(1,47,1),(1,48,2),(1,49,1),(1,50,1),(1,51,1),(1,52,1),(1,53,1),(1,54,1),(1,55,1),(1,56,1),(1,57,2),(1,58,1),(1,59,1),(1,60,1);
...
INSERT INTO `site_user_has_orders_stations` VALUES (2,1,3),(2,38,4),(2,39,1),(3,40,2),(2,41,2),(2,42,4),(2,43,1),(2,46,1),(7,47,1),(7,48,2),(3,49,1),(3,50,1),(9,52,1),(9,53,1),(9,54,1),(9,55,1),(10,57,2),(11,59,1),(2,60,1);
...
INSERT INTO `site_users` VALUES (2),(3),(7),(9),(10),(11);
...
INSERT INTO `station_has_orders_affilates` VALUES (3,1,1),(4,38,1),(1,39,2),(2,40,3),(2,41,3),(4,42,1),(1,43,2),(2,44,1),(1,45,2),(1,46,2),(1,47,1),(2,48,1),(1,49,1),(1,50,2),(1,51,2),(1,52,1),(1,53,1),(1,54,2),(1,55,2),(1,56,2),(2,57,1),(1,58,2),(1,59,2),(1,60,2);
...
INSERT INTO `station_profile_has_comments` VALUES (1,1),(1,3),(1,4),(1,5),(2,6),(3,9),(4,10),(4,11),(1,12),(1,14),(1,15),(1,17),(1,20),(1,23);
...
INSERT INTO `station_profile_has_marks` VALUES (1,1),(4,2),(3,3),(1,4),(1,5),(1,6),(1,7),(1,8);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `order_services_costs_counts` AS select `orders_services_counts`.`order_id` AS `order_id`,`orders_services_counts`.`count` AS `count`,`orders_services_costs`.`cost` AS `cost`,`services`.`name` AS `name`,(`orders_services_counts`.`count` * `orders_services_costs`.`cost`) AS `sum` from ((`orders_services_counts` left join `orders_services_costs` on(((`orders_services_counts`.`service_id` = `orders_services_costs`.`service_id`) and (`orders_services_counts`.`order_id` = `orders_services_costs`.`order_id`)))) left join `services` on((`orders_services_counts`.`service_id` = `services`.`service_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2015-09-06 11:31:01
